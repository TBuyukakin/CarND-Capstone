...
class DBWNode(object):
    ...
    def __init__(self):
        ...
        """
        Break commands should be units of torque (N/m) m*wheel_r*acceleration
        ...
        self.loop()
        """
        Publishing frequency need to be 50 Hz in order it to work
        """
    def loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            """
            From twist_controller.py, controller class is defined. Based on current
            velocity, obtain throttle, brake and steering	
            """
            if self.can_control():
